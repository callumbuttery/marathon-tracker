        ...
        <div className=''>
            ...
            <div className="flex justify-center items-center">
                ...
                <div className="ml-5 mr-5 w-5/12 bg-gray-200 rounded-full dark:bg-gray-700">
                    <div className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-xs font-medium text-black text-center p-0.5 leading-none rounded-full" style={{ width: percentageRaised + "%" }}> {percentageRaised}%</div>
                </div>
                <div className="font-mono text-xl text-white flex">£{target} <Icon path={mdiPartyPopper} size={1} className='ml-2 mr-2' color={'orange'}/></div>
            </div>
        </div>
    )
}