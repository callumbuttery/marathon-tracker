        ...
        <div className=''>
            ...
            <div className="flex justify-center items-center">
                ...
                <div className="ml-5 mr-5 w-5/12 bg-gray-200 rounded-full dark:bg-gray-700">
                    <div className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-xs font-medium text-white text-center p-0.5 leading-none rounded-full" style={{ width: "100%" }}> 0%</div>
                </div>
